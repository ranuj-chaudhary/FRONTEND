...
<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-gray-900 h-screen">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p class="mt-10 text-center text-sm/6 text-gray-400">
        Already have an account?
           <NuxtLink class="font-semibold text-indigo-400 hover:text-indigo-300"> Sign in </NuxtLink>
      </p>
    </div>
  </div>
</template>
